...
while True:
    ...
    if choice == 'new':
        ...
        with open('public/pairs.csv', 'w', newline='') as csvfile:
    ...
    elif choice == 'update' or choice == 'kill':
        killer = input("Got it! Who got a kill? (name):\n")
        with open('public/pairs.csv', 'r') as csvfile:
            ...
            for pair in pairs:
                if pair['name'] == killer:
                    target = pair['target']
                    print(f'Target for {killer} is {target}')
                    break
            
            for pair in pairs:
                if pair['name'] == target:
                    new_target = pair['target']
                    print(f'Target for {target} is {new_target}')
                    break
